  ...
  return (
    <div className="d-flex align-items-center justify-content-center form">
      <div className="form-wrapper">
        ...
        <p className="text-center px-4 py-3">By continuing, you agree to Terms of Service and acknowledge you've login our site.</p>
        ...
        <div className="login-btns text-center">
          <button className="google-signIn-btn px-3" onClick={handleGoogleSignIn}>
